                ...
                for (int i = 0; i < row; i++)
                {
                    for (int j = 0; j < col; j++)
                    {
                        ...
                        else
                        {
                            ...
                            //if no properties
                            if( i % 2 == 0)
                            go.transform.localPosition = vec + new Vector3(sprite_size * j * 19, -sprite_size * i * 4, 0);
                            else
                            go.transform.localPosition = vec + new Vector3(sprite_size * j * 19 + 9.5f, -sprite_size * i * 4, 0);
